...
def config():
    ...
    if not cfg.has_option('vars', 'filabel_repo'):
        raise MissingConfigError('FILABEL_REPO env var is missing!')
    if not cfg.has_option('vars', 'gh_user'):
        raise MissingConfigError('GH_USER env var is missing!')
    if not cfg.has_option('vars', 'gh_token'):
        raise MissingConfigError('GH_TOKEN env var is missing!')
